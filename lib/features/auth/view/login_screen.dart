...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    final validatorProvider = Provider.of<ValidatorProvider>(context, listen: false);
    return SafeArea(
      child: Scaffold(
                  ...
                  child: Consumer<LoginProvider>(builder: (context, login, _) {
                    return Form(
                      ...
                      child: Column(
                        children: [
                          FieldUsername(
                              validator: (value) => validatorProvider.validateUsername(value),
                          ...
                          FieldPassword(
                            validator: (value) => validatorProvider.validatePassword(value),
